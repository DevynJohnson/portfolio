...
function ContactMe() {
  return (
    <div className='contactMePage'>
      <h4>
        Please reach out if you are interested in discussing job opportunities,
      ...
      <h4>
        ...
        connect with me on <a href="https://www.linkedin.com/in/devyn-johnson-a5259213b/"target="_blank">LinkedIn</a>, or my mobile phone at 651-238-6818 or by using the form below.
      </h4>
