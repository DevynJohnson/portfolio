...
import get2KnowMeImg from "../images/Get2KnowMe.png";
import pexImg from "../images/PEX.png";
...
export const projectData = [
  ...
  },
  {
    ...
    projectDescription:
      "A comprehensive, mobile-responsive professional website developed using React and modern JavaScript frameworks for a licensed real estate professional serving the Twin Cities metropolitan area. This client-focused digital platform serves as the agent's primary online presence, featuring seamless integration with current MLS listings, comprehensive buyer and seller resource centers, and multiple streamlined contact channels for lead generation. The project encompassed the complete software development lifecycle from initial stakeholder consultation and content strategy through final deployment and ongoing maintenance. Key technical implementations include responsive design optimization, SEO best practices, performance optimization, and user experience design principles. This real-world client project provided valuable experience in professional client communication, project timeline management, and delivering production-ready applications that directly impact business outcomes and client acquisition in the competitive real estate market.",
  },
  {
    id: 4,
